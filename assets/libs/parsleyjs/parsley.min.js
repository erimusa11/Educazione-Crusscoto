...
! function(e, t) {
   ...
   e.extend(!0, T, {
       ...
       type: {
           email: "Questo valore dovrebbe essere un indirizzo email valido.",
           url: "Questo valore dovrebbe essere un URL valido.",
           number: "Questo valore dovrebbe essere un numero valido.",
           integer: "Questo valore dovrebbe essere un numero intero valido.",
           digits: "Questo valore dovrebbe essere composto da cifre.",
           alphanum: "Questo valore dovrebbe essere alfanumerico."
       },
       ...
       max: "Questo valore dovrebbe essere inferiore o uguale a %s.",
       range: "This value should be between %s and %s.",
       minlength: "Questo valore e troppo corto. Dovrebbe avere %s caratteri o piu.",
       maxlength: "This value is too long. It should have %s characters or fewer.",
       length: "This value length is invalid. It should be between %s and %s characters long.",
       mincheck: "You must select at least %s choices.",
       maxcheck: "You must select %s choices or fewer.",
       check: "You must select between %s and %s choices.",
       equalto: "Questo valore dovrebbe essere lo stesso."
   }), T.setLocale("en");
   var I = new n;
   I.install();
   var q = T;
